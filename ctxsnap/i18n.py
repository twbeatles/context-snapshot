...
TRANSLATIONS = {
    "en": {
        ...
        "Restore Profiles": "Restore Profiles",
        "Enable Sync Feature": "Enable Sync Feature",
        "Enable Security Feature": "Enable Security Feature",
        "Enable Advanced Search": "Enable Advanced Search",
        "Enable Restore Profiles": "Enable Restore Profiles",
        "Developer Features": "Developer Features",
        "Sync Settings": "Sync Settings",
        "Provider": "Provider",
        "Local Sync Root": "Local Sync Root",
        "Sync Interval (minutes)": "Sync Interval (minutes)",
        "Sync Now": "Sync Now",
        "Enable DPAPI": "Enable DPAPI",
        "Encrypt Note": "Encrypt Note",
        "Encrypt TODOs": "Encrypt TODOs",
        "Encrypt Processes": "Encrypt Processes",
        "Encrypt Running Apps": "Encrypt Running Apps",
        "Security Settings": "Security Settings",
        "Enable Field Query": "Enable Field Query",
        "Saved queries (comma-separated)": "Saved queries (comma-separated)",
        "Saved Queries": "Saved Queries",
        "Search Settings": "Search Settings",
        "Encrypt backup with DPAPI": "Encrypt backup with DPAPI",
        "Name": "Name",
        "Import snapshots": "Import snapshots",
        "Import snapshots strategy": "Snapshots are included in this backup. Choose how to apply them.",
        "Merge strategy": "Merge: keep local and add new only",
        "Overwrite strategy": "Overwrite: replace snapshots with same ID",
        "Replace strategy": "Replace all: remove local snapshots then import backup",
        "Sync done status": "Sync done: {snapshots} snapshots, {conflicts} conflicts.",
        "Sync failed status": "Sync failed.",
        "Settings applied status": "Settings applied.",
        "Encrypt existing snapshots": "Encrypt existing snapshots",
        "Security migration requires DPAPI": "Enable Security Feature and DPAPI before encrypting existing snapshots.",
        "DPAPI unavailable": "Windows DPAPI is unavailable on this machine.",
        "Encrypt existing snapshots confirm": "Encrypt existing plaintext snapshot fields now? A safety backup will be created first.",
        "Security migration done": "Encrypted {count} snapshots. Safety backup: {backup}",
        "Security migration failed": "Failed to encrypt existing snapshots. Changes were rolled back.",
        "Sync requires enabled flag": "Enable Sync Feature before running Sync Now.",
        "Imported": "Imported",
        "Current": "Current",
        "Use imported default root": "Use imported default root",
        "Keep current default root": "Keep current default root",
        "Import default root choice": "This backup includes a different default root. Choose which one to keep.",
        "Restore Again": "Restore Again",
        "Sync Conflicts": "Sync Conflicts",
        "Select a conflict to view details.": "Select a conflict to view details.",
        "No sync conflicts yet": "No sync conflicts yet.",
        "Open Sync Conflicts": "Open Sync Conflicts",
    },
    "ko": {
        "New Snapshot": "새 스냅샷",
        ...
        "Restore Profile": "복원 프로필",
        "Profile name": "프로필 이름",
        "Default profile": "기본 프로필",
        "Restore Profiles": "복원 프로필",
        "Enable Sync Feature": "동기화 기능 사용",
        "Enable Security Feature": "보안 기능 사용",
        "Enable Advanced Search": "고급 검색 사용",
        "Enable Restore Profiles": "복원 프로필 사용",
        "Developer Features": "개발자 기능",
        "Sync Settings": "동기화 설정",
        "Provider": "공급자",
        "Local Sync Root": "로컬 동기화 경로",
        "Sync Interval (minutes)": "동기화 간격 (분)",
        "Sync Now": "지금 동기화",
        "Enable DPAPI": "DPAPI 사용",
        "Encrypt Note": "메모 암호화",
        "Encrypt TODOs": "TODO 암호화",
        "Encrypt Processes": "프로세스 암호화",
        "Encrypt Running Apps": "실행 앱 암호화",
        "Security Settings": "보안 설정",
        "Enable Field Query": "필드 검색 사용",
        "Saved queries (comma-separated)": "저장 검색식 (쉼표 구분)",
        "Saved Queries": "저장 검색식",
        "Search Settings": "검색 설정",
        "Encrypt backup with DPAPI": "백업을 DPAPI로 암호화",
        "Name": "이름",
        "Import snapshots": "스냅샷 가져오기",
        "Import snapshots strategy": "백업에 스냅샷이 포함되어 있습니다. 적용 방식을 선택하세요.",
        "Merge strategy": "Merge: 기존은 유지하고 새 항목만 추가",
        "Overwrite strategy": "Overwrite: 같은 ID는 덮어쓰기",
        "Replace strategy": "Replace all: 현재 스냅샷을 모두 삭제 후 백업으로 교체",
        "Sync done status": "동기화 완료: 스냅샷 {snapshots}개, 충돌 {conflicts}개",
        "Sync failed status": "동기화 실패",
        "Settings applied status": "설정이 적용되었습니다.",
        "Encrypt existing snapshots": "기존 스냅샷 암호화",
        "Security migration requires DPAPI": "기존 스냅샷을 암호화하려면 보안 기능과 DPAPI를 먼저 켜세요.",
        "DPAPI unavailable": "이 장치에서 Windows DPAPI를 사용할 수 없습니다.",
        "Encrypt existing snapshots confirm": "기존 평문 스냅샷 필드를 지금 암호화할까요? 먼저 안전 백업을 생성합니다.",
        "Security migration done": "스냅샷 {count}개 암호화 완료. 안전 백업: {backup}",
        "Security migration failed": "기존 스냅샷 암호화에 실패했습니다. 변경 사항을 롤백했습니다.",
        "Sync requires enabled flag": "지금 동기화를 실행하려면 동기화 기능을 먼저 켜세요.",
        "Imported": "가져온 값",
        "Current": "현재 값",
        "Use imported default root": "가져온 기본 경로 사용",
        "Keep current default root": "현재 기본 경로 유지",
        "Import default root choice": "백업에 현재와 다른 기본 경로가 포함되어 있습니다. 사용할 값을 선택하세요.",
        "Restore Again": "다시 복원",
        "Sync Conflicts": "동기화 충돌",
        "Select a conflict to view details.": "충돌 항목을 선택하여 상세 내용을 확인하세요.",
        "No sync conflicts yet": "동기화 충돌이 없습니다.",
        "Open Sync Conflicts": "동기화 충돌 열기",
    }
