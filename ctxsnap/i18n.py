...
TRANSLATIONS = {
    "en": {
        ...
        "Open recent files in VSCode": "Open recent files in VSCode",
        "Recent files to open": "Recent files to open",
        "Terminal": "Terminal",
        "Terminal mode": "Terminal mode",
        "Custom argv": "Custom argv",
        "Terminal custom argv hint": "One argument per line. Use {path} for the root folder path.",
        "Saved searches": "Saved searches",
        "Saved search name": "Name",
        "Saved search query": "Query",
        "Saved search query required": "Query is required.",
        "Name": "Name",
        "Query": "Query",
        "Auto": "Auto",
        "Custom": "Custom",
        ...
        "Saved": "Saved",
        "Current": "Current",
        "Git mismatch warn": "Git state differs from the saved snapshot.",
        "Select all": "Select all",
        "Select none": "Select none",
        "No recent files to open": "No recent files to open.",
    ...
    "ko": {
        ...
        "Search presets": "프리셋",
        "Open recent files in VSCode": "VSCode에서 최근 파일 열기",
        "Recent files to open": "열 파일 수",
        "Terminal": "터미널",
        "Terminal mode": "터미널 모드",
        "Custom argv": "커스텀 argv",
        "Terminal custom argv hint": "한 줄에 한 인자. {path}는 Root 경로로 치환됩니다.",
        "Saved searches": "저장된 검색",
        "Saved search name": "이름",
        "Saved search query": "쿼리",
        "Saved search query required": "쿼리를 입력해야 합니다.",
        "Name": "이름",
        "Query": "쿼리",
        "Auto": "자동",
        "Custom": "사용자 지정",
        ...
        "Saved": "저장됨",
        "Current": "현재",
        "Git mismatch warn": "Git 상태가 스냅샷과 다릅니다.",
        "Select all": "전체 선택",
        "Select none": "전체 해제",
        "No recent files to open": "열 수 있는 최근 파일이 없습니다.",
        "Root folder": "루트 폴더",
